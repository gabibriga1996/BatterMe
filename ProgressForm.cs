...
namespace BetterMeV2VSTO
{
    public class ProgressForm : Form
    {
        ...
        public ProgressForm(string message)
        {
            ...
            {
                Interval = 50 // Smooth 20fps animation
            };
            _animationTimer.Tick += (s, e) =>
            {
                _rotation = (_rotation + 12) % 360; // 12 degrees per frame
                Invalidate(); // Redraw the spinner
            };
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // Draw modern card-like background with rounded corners
        ...
        private void DrawModernSpinner(Graphics g, Point center, int radius)
        {
            ...
            for (int i = 0; i < segments; i++)
            {
                ...
                var alpha = (int)(255 * (1.0 - (double)i / segments)); // Fade effect
                ...
                using (var pen = new Pen(Color.FromArgb(alpha, 0, 120, 215), thickness)) // Windows blue
                {
